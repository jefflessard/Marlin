...
#endif
#if (defined(IIC_EEPROM_SDA) && IIC_EEPROM_SDA >= 0) //TODO  rename IIC_EEPROM_SDA to IIC_EEPROM_SDA_PIN
  REPORT_NAME_DIGITAL(__LINE__, IIC_EEPROM_SDA)
#endif
#if (defined(IIC_EEPROM_SCL) && IIC_EEPROM_SCL >= 0) //TODO  rename IIC_EEPROM_SCL to IIC_EEPROM_SCL_PIN
  REPORT_NAME_DIGITAL(__LINE__, IIC_EEPROM_SCL)
#endif
#if PIN_EXISTS(EEPROM_WP)
  REPORT_NAME_DIGITAL(__LINE__, EEPROM_WP_PIN)
#endif
#if HAS_KILL
