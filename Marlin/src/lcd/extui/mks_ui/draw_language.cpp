...
static void event_handler(lv_event_t *event) {
  ...
  switch (mks_data(event).mks_obj_id) {
    case ID_CN:
      ...
      //TODO upgrade to lvgl8 lv_obj_refresh_ext_draw_pad(buttonCN);
    ...
    case ID_T_CN:
      ...
      //TODO upgrade to lvgl8 lv_obj_refresh_ext_draw_pad(buttonT_CN);
    ...
    case ID_EN:
      ...
      //TODO upgrade to lvgl8 lv_obj_refresh_ext_draw_pad(buttonEN);
    ...
    case ID_RU:
      ...
      //TODO upgrade to lvgl8 lv_obj_refresh_ext_draw_pad(buttonRU);
    ...
    case ID_ES:
      ...
      //TODO upgrade to lvgl8 lv_obj_refresh_ext_draw_pad(buttonES);
    ...
    case ID_FR:
      ...
      //TODO upgrade to lvgl8 lv_obj_refresh_ext_draw_pad(buttonFR);
    ...
    case ID_IT:
      ...
      //TODO upgrade to lvgl8 lv_obj_refresh_ext_draw_pad(buttonIT);
...
static void disp_language(uint8_t language, uint8_t state) {
  ...
  //TODO upgrade to lvgl8 if (state == UNSELECTED) lv_obj_refresh_ext_draw_pad(obj);
}
...
void lv_draw_language() {
  ...
  //TODO upgrade to lvgl8 lv_obj_clear_protect(buttonCN, LV_PROTECT_FOLLOW);
