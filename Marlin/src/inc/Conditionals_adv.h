...
#define ANY_THERMISTOR_IS(N) (0 REPEAT2(HOTENDS, _E_SENSOR_IS, N) \
  ...
  #if defined(TEMP_SENSOR_BOARD_INTERNAL_CAL1_TEMP) && defined(TEMP_SENSOR_BOARD_INTERNAL_CAL1_ADDR) && defined(TEMP_SENSOR_BOARD_INTERNAL_CAL2_TEMP) && defined(TEMP_SENSOR_BOARD_INTERNAL_CAL2_ADDR)
    #define TEMP_SENSOR_BOARD_IS_INTERNAL_CALIBRATED 1
  #elif defined(TEMP_SENSOR_BOARD_INTERNAL_TYPICAL_VOLT) && defined(TEMP_SENSOR_BOARD_INTERNAL_TYPICAL_SLOPE) && defined(TEMP_SENSOR_BOARD_INTERNAL_TYPICAL_TEMP)
    #define TEMP_SENSOR_BOARD_IS_INTERNAL_TYPICAL 1
  #endif
