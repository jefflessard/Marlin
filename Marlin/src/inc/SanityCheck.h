 ...
 */
  ...
  #elif ENABLED(TEMP_SENSOR_BOARD_IS_INTERNAL)
    #if NONE(TEMP_SENSOR_BOARD_IS_INTERNAL_TYPICAL, TEMP_SENSOR_BOARD_IS_INTERNAL_CALIBRATED)
      #error "TEMP_SENSOR_BOARD=-1000 requires either typical values (x_INTERNAL_TYPICAL_VOLT, x_INTERNAL_TYPICAL_SLOPE, x_INTERNAL_TYPICAL_TEMP) or calibrated references (x_INTERNAL_CAL1_TEMP, x_INTERNAL_CAL1_ADDR, x_INTERNAL_CAL2_TEMP, x_INTERNAL_CAL2_ADDR)."
    #endif
  #endif
