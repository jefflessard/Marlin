...
#define STRING_CONFIG_H_AUTHOR "Jean-Francois Lessard" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 210.56
  #define DEFAULT_bedKi 34.18
  #define DEFAULT_bedKd 864.71
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -6, -3.8 } // Z-4.30 stock nozzle, Z-3.8 cheap nozzle
...
//#define TFT_LVGL_UI
  ...
  //#define DEBUG_MKS_UI
  #define LVGL_BUFFER_LINES 24 // Recmmendend LCD_Vertical_Resolution/10. E.g. 320 / 10 = 32. But may be too large to hold on RAM.
  //fea#define LVGL_USE_DUAL_BUFFER
